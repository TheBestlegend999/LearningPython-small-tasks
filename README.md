...
- [26_while_loop_sum.py](tasks/26_while_loop_sum.py) → use a while loop with an else clause to calculate the sum of numbers from 0 to 100 and display the total after the loop ends
